...
about = {}
with open(os.path.join(BASE_DIR, 'usbsecurity_server', '__version__.py')) as f:
    exec(f.read(), about)
...
setup(
    ...
    keywords=['usb', 'security', 'ports', 'devices', 'server'],
    platforms=['Linux', 'Windows', 'MacOS'],
    packages=find_packages(),
    entry_points={
        'console_scripts': [
            'usbsecurity-server=usbsecurity_server.server:main',
        ]
    },
